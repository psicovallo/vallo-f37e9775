  ...
  try {
    ...
    return new Response(
      JSON.stringify({
        ...
        monthly_financial_target: monthlyTarget,
        daily_value: Math.round(dailyValue * 100) / 100,
        vice_penalty: vicePenalty,
        sovereign_base: Math.round(sovereignBase * 100) / 100,
        financial_debt: newDebt,
        lucidity_level: newLucidity,
        sovereign_streak: newStreak,
        last_vice_timestamp: newVice,
